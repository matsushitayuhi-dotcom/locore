    ...
    <form onSubmit={onSubmit} className="space-y-5">
      ...
      <Field label="カテゴリ" required>
        <select
          ...
          className="flex h-11 w-full rounded-sm border border-border bg-card px-3 text-body-md text-foreground focus:border-2 focus:border-primary-500 focus:outline-none focus:px-[11px]"
          required
        >
          {CATEGORIES.map((c) => (
