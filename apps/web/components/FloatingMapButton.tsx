...
export function FloatingMapButton() {
  return (
    <Link
      href="/map"
      aria-label="地図で見る"
      className="fixed bottom-20 right-4 z-30 inline-flex h-12 w-12 items-center justify-center rounded-full bg-primary-500 text-neutral-950 shadow-lg ring-2 ring-card transition hover:bg-primary-300 active:scale-95"
      style={{
