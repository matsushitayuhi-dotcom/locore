...
export const blockSchema = z.discriminatedUnion('type', [
  ...
  z.object({ id, type: z.literal('takeaways'), label: short.optional(), items: z.array(short).max(8) }),
  ...
  z.object({ id, type: z.literal('proscons'), prosLabel: short.optional(), consLabel: short.optional(), pros: z.array(short).max(10), cons: z.array(short).max(10) }),
