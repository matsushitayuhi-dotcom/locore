    ...
    <form onSubmit={onSubmit} className="space-y-3">
      <div>
        ...
        <select
          ...
          className="flex h-10 w-full rounded-sm border border-neutral-200 bg-neutral-0 px-3 text-body-sm focus:border-2 focus:border-primary-700 focus:outline-none focus:px-[11px]"
        >
          {STATUSES.map((s) => (
      ...
      <div>
        ...
        <textarea
          ...
          className="flex w-full rounded-sm border border-neutral-200 bg-neutral-0 px-3 py-2 text-body-sm focus:border-2 focus:border-primary-700 focus:outline-none focus:px-[11px] focus:py-[7px]"
        />
      </div>
      <Button
        type="submit"
