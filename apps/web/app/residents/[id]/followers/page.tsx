...
import { listFollowers } from '@/lib/follow/actions';
import { RESIDENCE_COUNTRY_BY_CODE } from '@/lib/resident/masters';

/**
 * /residents/[id]/followers — フォロワー一覧。
 *
 * NOTE: RLS の関係で「自分のフォロワー」しか見えない場合があります。
 *       他人のページでは空表示になる可能性あり（仕様）。
 */

export const dynamic = 'force-dynamic';
export const metadata = { title: 'フォロワー — Locore' };
...
export default async function FollowersPage({
  ...
  const followers = await listFollowers(params.id);
