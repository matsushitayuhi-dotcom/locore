    ...
    <article className="prose-legal max-w-prose">
      ...
      <Section n="第2条" title="定義">
        <ol>
          ...
          <li>
            <strong>有料コンテンツ</strong>: 当社が定める範囲内でクリエイターが
            販売価格を設定するデジタルコンテンツをいいます。具体的な販売価格は
            各商品ページに明示します。
          </li>
          <li>
      ...
      <Section n="第4条" title="クリエイター申請と居住確認">
        <ol>
          ...
          <li>
            提出された書類は、原則として確認の目的を達成した後、合理的な期間内に
            当社管理下から削除されます (GDPR 配慮)。詳細はプライバシーポリシーをご覧ください。
          </li>
        </ol>
      </Section>
      ...
      <Section n="第5条" title="記事の販売と購入">
        <ol>
          <li>
            ...
            具体的な販売価格は各記事ページに明示します。
          </li>
          <li>
            購入は当社が指定する決済代行サービスを通じたクレジットカード決済等で行われます。
          </li>
          <li>
          ...
          <li>
            記事の品質に著しい問題がある場合、当社が定める一定期間内に
            運営にお問い合わせいただければ、個別に返金対応します。
          </li>
        </ol>
      </Section>
      ...
      <Section n="第6条" title="売上配分">
        <ol>
          <li>
            ...
            当社が別途定める所定の運営手数料を控除した残額をクリエイターが受領します。
            具体的な手数料率の詳細はクリエイター契約書類にてご確認いただけます。
          </li>
          <li>
            立ち上げ期の特定枠のクリエイターは、別途定める優遇手数料率が適用される場合があります。
          </li>
          <li>
            クリエイターへの支払いは、決済代行サービスを通じて定期的に行います。
          </li>
        </ol>
      </Section>
      ...
      <Section n="第9条" title="モデレーションと削除">
        <ol>
          ...
          <li>
            通報を受けたコンテンツは、運営チームが合理的な期間内に確認します。
          </li>
        </ol>
      </Section>
