...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    data-locore-component="Card"
    className={cn(
      "bg-card text-card-foreground rounded-md border border-border shadow-xs",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "font-serif text-heading-md text-neutral-900 leading-snug",
      className,
    )}
    {...props}
  />
