  ...
  const articleRows: NewArticle[] = [
    {
      ...
      isSample: true,
      // ---- 0091: エディトリアル版（ブロック形式）。記事ページと執筆エディタの表示確認用 ----
      bodyStyle: 'blocks',
      ...
      topic: 'mba',
      blocks: [
        { id: 'b-take', type: 'takeaways', items: ['日本人が MBA エッセイで最初にやりがちな 3 つの書き方', '直す順番と、直す前後の実例', '出願スケジュールと費用の目安'] },
        { id: 'b-h1', type: 'heading', level: 2, text: '罠 1 — 実績の列挙' },
        { id: 'b-p1', type: 'paragraph', text: '日本の職務経歴書の感覚でプロジェクトを並べると、審査側には何も残りません。エッセイで見られているのは実績の大きさではなく、**意思決定の理由と、そこからの変化**です。' },
        { id: 'b-l1', type: 'list', style: 'bullet', items: ['「何をしたか」ではなく「なぜそう決めたか」を先に書く', '数字は 1 段落に 1 つまで。多いほど印象が薄まる', '失敗した判断を 1 つ入れると、残りの実績が立体的になる'] },
        { id: 'b-q1', type: 'quote', text: 'あなたが主語の文章を読みたい。', cite: '添削してくれた HBS 2 年生。この一言で第 1 稿の半分を捨てました' },
        { id: 'b-h2', type: 'heading', level: 2, text: '罠 2 — 謙遜' },
        { id: 'b-p2', type: 'paragraph', text: '文化的にどうしても「チームのおかげ」と書きたくなりますが、adcom が知りたいのはあなた個人が何を判断し、何を動かしたか。主語を I に戻す作業が最初のドラフトの半分を占めました。' },
        { id: 'b-a1', type: 'aside', kind: 'point', label: 'やること', text: '「私たちは」で始まる段落を数えて、半分以下にする。残りは「私は」に書き換えるか、削る。' },
        { id: 'b-h2b', type: 'heading', level: 3, text: '直す前・直した後' },
        { id: 'b-t1', type: 'table', rows: [['直す前', '直した後'], ['チームで新規事業を立ち上げ、売上 3 億円を達成した', '反対が多かった B 案を私が選び、根拠として 2 週間で顧客 40 社に会った'], ['上司の指導のもと、業務改善に取り組んだ', '週次の会議を廃止し、代わりに私が 1 対 1 を 12 人と回した']] },
        ...
        { id: 'b-st', type: 'stats', items: [{ value: '¥1,400 万', label: '1 年の学費＋生活費（2025 年・ボストン）' }, { value: '4 か月', label: '推薦者打診から提出まで' }, { value: '2 / 2 校', label: '出願した学校と合格した学校' }] },
        { id: 'b-faq', type: 'faq', items: [{ q: 'GMAT と GRE、どちらで出すべき？', a: '学校が指定しない限りどちらでも。数学が得意なら GRE の方が伸びやすい人が多いです。' }, { q: '推薦状は日本語で書いてもらってもいい？', a: '翻訳を添えれば可の学校が多いですが、推薦者本人の英語で書いてもらう方が信頼されます。' }] },
        { id: 'b-p4', type: 'paragraph', text: '自分の職歴でどう書くべきかは人によって全く違います。ドラフト前の構成段階で一度壁打ちするのがおすすめです。' },
        { id: 'b-fn', type: 'footnotes', items: ['HBS Admissions, Application Fee（2026-09-01 閲覧）', '為替は 1 ドル 150 円で計算'] },
      ],
    },
    {
